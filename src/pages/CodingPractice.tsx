...
import { Code, Play, CheckCircle, Trophy, Target, Clock, Star, BookOpen, Save, Send, Loader2 } from 'lucide-react';
...
const CodingPractice = () => {
  ...
  const saveCode = () => {
    ...
    localStorage.setItem(`code_${selectedProblem}_${selectedLanguage}`, code);
    toast({
      title: "Code Saved",
