...
const StudyPlan = () => {
  ...
  const generateAIPlan = async () => {
    if (!aiPrompt.trim()) {
      toast({
        title: "Error",
        description: "Please enter a prompt for the AI study plan.",
        variant: "destructive"
      });
      return;
    }
    ...
    setTimeout(() => {
      const samplePlan = `Based on your request: "${aiPrompt}"

Here's your personalized study plan:

📚 **Week 1-2: Foundation Building**
• Review core concepts and fundamentals
• Practice basic exercises daily (30-45 minutes)
• Create summary notes for each topic

📖 **Week 3-4: Deep Dive**
• Focus on challenging areas identified
• Solve advanced problems and case studies
...
This plan adapts to your specific goals and can be adjusted based on your progress.`;
      
      setAiGeneratedPlan(samplePlan);
